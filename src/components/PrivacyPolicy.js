...
const PrivacyPolicy = () => {
    ...
    return (
        <div class="privacy">
            <div id='ppHeader'>http://bravo-ai-stil.herokuapp.com Privacy Policy</div>
            <div id='ppBody'>
                ...
                <div className='innerText'>This privacy policy has been compiled to better serve those who are concerned
                    with how their 'Personally Identifiable Information' (PII) is being used online. PII, as described
                ...
                <div class='innerText'> We may use the information we collect from you when you register, make a
                    ...
                    the website, or use certain other site features in the following ways:<br/></div>
                ...
                <div class='innerText'>We do not use Malware Scanning.<br/></div>
                <div class='innerText'>We do not use an SSL certificate</div>
                <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> We do not need an
                    SSL because:
                </div>
                ...
                <div class='innerText'><br/><strong>If users disable cookies in their browser:</strong>

                </div>
                <div class='innerText'>If you turn cookies off, Some of the features that make your site
                    experience more efficient may not function properly.Some of the features that make your
                ...
                <div class='innerText'>Google's advertising requirements can be summed up by Google's
                    ...
                    users. https://support.google.com/adwordspolicy/answer/1316548?hl=en <br/></div>
                <div class='innerText'>We use Google AdSense Advertising on our website.</div>
                <div class='innerText'><br/>Google, as a third-party vendor, uses cookies to serve ads on
                    our site. Google's use of the DART cookie enables it to serve ads to our users based
                    on previous visits to our site and other sites on the Internet. Users may opt-out of
                    the use of the DART cookie by visiting the Google Ad and Content Network privacy
                    policy.<br/></div>
                <div class='innerText'><br/><strong>We have implemented the following:</strong></div>

                <div class='innerText'>The Fair Information Practices Principles form the backbone
                    ...
                    personal information.<br/></div>
                <div class='innerText'><strong>In order to be in line with Fair Information
                ...
                <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Within
                    1 business day
                </div>
                ...
                <div class='innerText'>The CAN-SPAM Act is a law that sets the rules for commercial
                    ...
                    penalties for violations.<br/></div>
                ...
                <div class='innerText'>If there are any questions regarding this privacy policy, you may
                    contact us
                    using the information below.<br/></div>
                <div class='innerText'>http://bravo-ai-stil.herokuapp.com</div>
                <div class='innerText'>0040754275672</div>
                <div class='innerText'>Last Edited on 2018-03-17</div>
